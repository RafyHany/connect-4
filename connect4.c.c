...
int pop ();
void undo(int a[] );
void redo(int a [] , int w , int c , int score , int undos);
            ...
            else
            {
                ...
                switch(op)
                {
                    case 'u' : undo(a);
                      ...
                      undos++ ;
                      break ;
                    case 'r' : redo(a,w,BACKGROUND_RED,score1,undos);
                       i++;
                       undos--;
                      break;
                    case 's' : printf("save");
                      break;
                    case 'q' : printf("quit game");
                    break;
                }
            }
        }
             ...
             else
            {
                ...
                switch(op)
                {
                    case 'u' : undo(a);
                      ...
                      undos++ ;
                      break ;
                    case 'r' : redo(a,w,BACKGROUND_GREEN,score2,undos);
                       i++;
                       undos-- ;
                      break;
                    case 's' : printf("save");
        ...
        if ( q == 0){
            ...
            else
            {
                ...
                switch(op)
                {
                    ...
                    case 'r' : redo(a,w,BACKGROUND_RED,score1,undos);
                       i++;
                       redo(a,w,BACKGROUND_GREEN,score2,undos);
                       i++;
                      break;
                    case 's' : printf("save");
                      break;
